...
def main():
    ...
    warehouse = WarehouseEnv(test_lvl34, BLOCK_SIZE, NUM_AGENTS, gamma, batch_size, buffer_size,
                  min_replay_size, eps, eps_min, eps_dec, update_freq, "test_lvl34") #Environment initialized
