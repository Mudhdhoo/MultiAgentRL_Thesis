...
def main():
    ...
    buffer_size = 125000 #Max number of transitions stored
    min_replay_size = 62500  #Minimum amount of transitions in replay before training
    eps_max = 1
    ...
    warehouse = WarehouseEnv(test_3comm, BLOCK_SIZE, NUM_AGENTS, gamma, batch_size, buffer_size,
                  min_replay_size, eps, eps_min, eps_dec, update_freq, "test_3comm") #Environment initialized
    playing = True
