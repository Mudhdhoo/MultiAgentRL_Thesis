...
def main():
    ...
    min_replay_size = 75000  #Minimum amount of transitions in replay before training
    ...
    warehouse = WarehouseEnv(test_lvl32, BLOCK_SIZE, NUM_AGENTS, gamma, batch_size, buffer_size,
                  min_replay_size, eps, eps_min, eps_dec, update_freq, "test_lvl32") #Environment initialized
