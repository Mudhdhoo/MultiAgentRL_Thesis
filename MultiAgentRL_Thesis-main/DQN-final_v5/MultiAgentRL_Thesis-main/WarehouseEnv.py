        ...
        for agent in self.agents:
            ...
            if agent.done == False:
                for wall in self.level:
                    ...
                    if pygame.Rect.colliderect(agent.rect, wall.wall_element) and wall.texture == self.PICKUP_TEXTURE and not agent.has_package and wall.index == ((agent.index+1)%4+1):
